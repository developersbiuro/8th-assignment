import headimg1 from "../../assets/img/home1-img.png"
import headimg2 from "../../assets/img/home2-img.png"
import headimg3 from "../../assets/img/home3-img.png"
            ...
            <div className="swiper home-swiper">
                <div className="swiper-wrapper">
                    ...
                    <section className="swiper-slide">
                        <div className="home__content grid">
                            <div className="home__group">
                                <img src={headimg1}   alt="" className="home__img" />
                    ...
                    <section className="swiper-slide">
                        <div className="home__content grid">
                            <div className="home__group">
                                <img src={headimg2} alt="" className="home__img" />
                                <div className="home__indicator"></div>
                    ...
                    <section className="swiper-slide">
                        <div className="home__content grid">
                            <div className="home__group">
                                <img src={headimg3} alt="" className="home__img" />
                                <div className="home__indicator"></div>
